...
public class libarayclass {

	protected static WebDriver driver;
    protected static Properties config = new Properties();
    private static final Logger logger = LogManager.getLogger(libarayclass.class);
    ...
    public static void initializeBrowser() {
        ...
        if (browser.equalsIgnoreCase("chrome")) {
            ...
            options.addArguments("--incognito"); // Enable Incognito
            ...
            options.addArguments("-private"); // Enable Private Mode
            driver = new FirefoxDriver(options);
            logger.info("Launching Firefox browser in Private mode...");
        }
